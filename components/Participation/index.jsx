    ...
    <section className={styles.ParticipationSection} id={"participar"}>
      <div className={styles.container}>
        <div className={styles.leftSide}>
          ...
          Aqui na SouJunior, você poderá participar do projeto de muitas maneiras. Temos oportunidades para profissionais nível júnior e mentores das mais diversas áreas, caso você tenha o interesse de colocar a <q>mão na massa</q> e construir esse projeto conosco.<br/><br/>
