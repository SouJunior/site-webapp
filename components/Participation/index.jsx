            ...
            {textJr && (
              <>
                <p className={styles.p}>
                  ...
                  <b>ainda não tem toda experiência exigida</b> pelos
                  recrutadores e empresas para contratarem para uma vaga júnior.
                  <br />
                  <br />
                  Se você identificou que possui interesse e, alguma das
                  ...
                  <b>Github do SouJunior</b> por já estarem familiarizados com
                  as ferramentas e sobre como o projeto funciona.
                </p>
                <br />
                <br />
            ...
            {textSupporter && (
              <>
                <p className={styles.p}>
                  ...
                  abordem assuntos referentes às áreas de atuação de
