          ...
          <div className={textJr ? styles.textJr : styles.hide}>
            ...
            {textJr && (
              <>
                ...
                São as pessoas que querem trabalhar na área de tecnologia, estudaram ou estão estudando sobre a área de interesse, mas <b>ainda não tem toda a experiência 
                exigida</b> pelos recrutadores e empresas para o contratarem para uma vaga júnior.<br/><br/>
                ...
                Daremos sempre prioridade para aqueles que já participem do servidor <b>SouJunior no Discord</b> e do <b>Github do SouJunior</b> por
          ...
          <div className={textMentor ? styles.textMentor : styles.hide}>
            ...
            {textMentor && (
              <>
                ...
                Se você tem disponibilidade e interesse em contribuir para o SouJunior, preencha o formulário de inscrição que entraremos em contato quando tivermos
          ...
          <div className={textCommunity ? styles.textCommunity : styles.hide}>
            ...
            {textCommunity && (
              <>
                ...
                Como o SouJunior é uma plataforma Open Source, qualquer pessoa que se interesse pode acessar as informações sobre o andamento do projeto. <br/><br/>
                Desde <b>curiosos</b> que só querem dar uma olhadinha, até aqueles que queiram <b>observar como o SouJunior funciona</b>, antes de decidirem se querem participar do projeto ou não.<br/><br/>
